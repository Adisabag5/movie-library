    ...
    return (
        <footer className="mt-16 border-t border-bark/60 bg-sand/40">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-5 px-4 py-8 md:flex-row md:justify-between md:px-6">
                <Link
                    to="/"
                    className="group flex items-center gap-2 rounded-full transition-transform duration-300 hover:-translate-y-0.5 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-clay"
                >
                    ...
                    <span className="text-sm font-black tracking-tight text-ink">
                        Movie<span className="text-clay">Library</span>
                    </span>
                </Link>
                ...
                <ul className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
                    {links.map(({ to, label }) => (
                        <li key={to}>
                            <Link
                                to={to}
                                className="text-sm font-semibold text-ink-soft transition-colors duration-300 hover:text-clay focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-clay"
                            >
                                {label}
                            </Link>
                        </li>
                ...
                <p className="group flex items-center gap-1.5 text-sm text-ink-soft">
                    ...
                    <svg
                        ...
                        fill="currentColor"
                        aria-hidden="true"
                        className="text-clay transition-transform duration-300 group-hover:scale-125"
                    >
